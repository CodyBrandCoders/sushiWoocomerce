<?php
//--------------------------------------
// SHORTCODE: EVENT SYSTEM PAST
//--------------------------------------

function pastEventLoop(){
  ...
  if($query->have_posts()) :
    ...
    $output = '<h2 class="text-color-3 text-center h1">No Archived Events</h2>';
  endif;
  wp_reset_query();
  return $output;
}
add_shortcode("past_event_loop", "pastEventLoop");
